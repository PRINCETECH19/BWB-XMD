...
zokou({
  ...
  try {
    ...
    let imdbInfo = "Tap on the link to join movie channel on telegram and download movies there : https://t.me/Dmltzbot\n";
    imdbInfo += " ``` DML MD FILMS```\n";
    imdbInfo += "*Made by Daudy Musa*\n";
    imdbInfo += "🎬Title    : " + imdbData.Title + "\n";
    imdbInfo += "📅year      : " + imdbData.Year + "\n";
    imdbInfo += "⭐Assessment : " + imdbData.Rated + "\n";
    imdbInfo += "📆Release    : " + imdbData.Released + "\n";
